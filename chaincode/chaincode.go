...
func NewChaincode() *EMRChaincode {

	EMR := new(EMRChaincode)

	EMR.Info = metadata.InfoMetadata{
		Version:     "0.0.1",
		Title:       "EMR",
...
func (c *EMRChaincode) Set(ctx contractapi.TransactionContextInterface, data string) (string, error) {
	...
	reqJsonValue, err := json.Marshal(&patient)
	if err != nil {
		return "", errors.New(fmt.Sprintf("failed to convert data:%s", err.Error()))
	}
...
func (c *EMRChaincode) Update(ctx contractapi.TransactionContextInterface, data string) (string, error) {
...
func (c *EMRChaincode) Delete(ctx contractapi.TransactionContextInterface, key string) (string, error) {
...
// data query
func (c *EMRChaincode) Get(ctx contractapi.TransactionContextInterface, key string) (string, error) {
...
func (c *EMRChaincode) GetHistory(ctx contractapi.TransactionContextInterface, key string) (string, error) {
...
func (d *EMRChaincode) GetEvaluateTransactions() []string {
